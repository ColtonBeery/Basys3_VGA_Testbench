...
module square #(
    ...
    input wire [9:0] displayx,
    input wire [8:0] displayy,
...
//    output wire [11:0] o_y2,   // square bottom edge
    ...
    wire [11:0] o_x1;  // square left edge: 12-bit value: 0-4095
    wire [11:0] o_x2;  // square right edge: 12-bit value: 0-4095
    wire [11:0] o_y1;  // square top edge: 12-bit value: 0-4095
    wire [11:0] o_y2;  // square bottom edge: 12-bit value: 0-4095
    ...
    always @ (posedge i_clk) begin
        if ( (o_x1 >= 0) & (o_x2 <= D_WIDTH) & (o_y1 >= 0) & (o_x2 <= D_HEIGHT) ) 
        begin
            exists <= 1;
        end else 
            exists <= 0;
